...
var PaginationUI = function (props) {
    ...
    return (React__default["default"].createElement(ReactPaginate, { previousLabel: "\u00AB", nextLabel: "\u00BB", pageClassName: "", pageLinkClassName: "btn btn-sm", previousClassName: "", previousLinkClassName: "btn btn-sm", nextClassName: "", nextLinkClassName: "btn btn-sm", breakLabel: "...", breakClassName: "", breakLinkClassName: "btn btn-sm btn-disabled", pageCount: pageCount, marginPagesDisplayed: 2, pageRangeDisplayed: 3, onPageChange: handlePageChange, containerClassName: "btn-group justify-center pt-8", activeClassName: "", activeLinkClassName: "btn btn-sm btn-active", forcePage: currentPageIndex }));
};
...
//     return Promise.reject(error);
// });
var getRequest = function (path, param, instanceObj) {
    if (path === void 0) { path = ''; }
    if (param === void 0) { param = {}; }
    if (instanceObj === void 0) { instanceObj = instance; }
    return instanceObj.get(path, param);
    // .then(res => res)
    // .catch(err => Promise.reject(err.response ? err.response.data : err));
};
var postRequest = function (path, body, instanceObj) {
    if (path === void 0) { path = ''; }
    if (body === void 0) { body = {}; }
    if (instanceObj === void 0) { instanceObj = instance; }
    return instanceObj.post(path, body)
        .then(function (res) { return res.data; })
        .catch(function (err) { return Promise.reject(err.response ? err.response.data : err); });
};
var requestService = { getRequest: getRequest, postRequest: postRequest };

var getData = function (url, body) {
    return requestService.postRequest(url, body);
};

var mappingColumn = function (cols) {
    return cols.map(function (col) { return ({
        Header: col,
        accessor: col,
        type: 'input'
    }); });
...
var convertSignalToName = function (param) {
    switch (param) {
        case 'eq':
            return 'equals';
        case 'gte':
...
var FieldValue = function (props) {
    var register = props.register, defaultValue = props.defaultValue, dataType = props.dataType;
    var inputField = (React__default["default"].createElement("input", __assign$1({ type: "text", placeholder: "value", className: "input input-bordered select-primary", defaultValue: defaultValue }, register)));
    var dateField = (React__default["default"].createElement("input", __assign$1({ type: "date", placeholder: "value", className: "input input-bordered select-primary", defaultValue: defaultValue }, register)));
    return (React__default["default"].createElement("div", { className: "form-control" },
        dataType && (React__default["default"].createElement("label", { className: "label" },
            React__default["default"].createElement("span", { className: "label-text" }, "Value"))),
        dataType === "input" && inputField,
        dataType === "date" && dateField));
};

var ModalForm = function (props) {
    var isOpen = props.isOpen, setIsOpen = props.setIsOpen, onHandleSubmit = props.onHandleSubmit, tag = props.tag, columns = props.columns;
    var _a = useForm(), register = _a.register, handleSubmit = _a.handleSubmit, setValue = _a.setValue, watch = _a.watch;
    var _b = React.useState([]), fieldList = _b[0], setfieldList = _b[1];
    var _c = React.useState(""), selectedField = _c[0], setSelectedField = _c[1];
    // handling choosing field value
    var onHandleFieldValue = function (selectedColumn) {
        var field = fieldList.find(function (item) { return item.value === selectedColumn; });
        if (field) {
    ...
    React.useEffect(function () {
        if (columns) {
            setfieldList(columns.map(function (item) {
                return ({
                    value: item.accessor,
                    label: item.Header,
                    type: item.type,
    ...
    React.useEffect(function () {
        ...
        var column = columns.find(function (item) { return tag.field === item.accessor; });
        if (column) {
    ...
    var watchField = watch("field", false);
    ...
    return (React__default["default"].createElement("div", { id: "my-modal", className: "modal ".concat(isOpen && "modal-open") },
        React__default["default"].createElement("div", { className: "modal-box absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50" },
            React__default["default"].createElement("form", { autoComplete: "off", onSubmit: handleSubmit(onHandleSubmit, onError) },
                React__default["default"].createElement("div", { className: "form-control hidden" },
                    React__default["default"].createElement("label", { className: "label" },
                        React__default["default"].createElement("span", { className: "label-text" }, "id")),
                    React__default["default"].createElement("input", __assign$1({ type: "text", placeholder: "value", className: "input input-bordered select-primary" }, register("id"), { value: tag === null || tag === void 0 ? void 0 : tag.id }))),
                React__default["default"].createElement("div", { className: "form-control" },
                    React__default["default"].createElement("label", { className: "label" },
                        React__default["default"].createElement("span", { className: "label-text" }, "Field")),
                    React__default["default"].createElement("select", __assign$1({ defaultValue: tag === null || tag === void 0 ? void 0 : tag.field, className: "select select-bordered select-primary w-full" }, register("field")), fieldList.map(function (option) { return (React__default["default"].createElement("option", { value: option.value }, option.label)); }))),
                React__default["default"].createElement("div", { className: "form-control" },
                    React__default["default"].createElement("label", { className: "label" },
                        React__default["default"].createElement("span", { className: "label-text" }, "Operator")),
                    React__default["default"].createElement("select", __assign$1({ defaultValue: tag === null || tag === void 0 ? void 0 : tag.operator, className: "select select-bordered select-primary w-full" }, register("operator")), operators.map(function (option) { return (React__default["default"].createElement("option", { value: option.value }, option.label)); }))),
                React__default["default"].createElement(FieldValue, { register: register("value"), defaultValue: tag === null || tag === void 0 ? void 0 : tag.value, dataType: selectedField }),
                React__default["default"].createElement("div", { className: "form-control" },
                    React__default["default"].createElement("label", { className: "label" },
                        React__default["default"].createElement("span", { className: "label-text" }, "Logic")),
                    React__default["default"].createElement("select", __assign$1({ defaultValue: tag === null || tag === void 0 ? void 0 : tag.logic, className: "select select-bordered select-primary w-full" }, register("logic")), logics.map(function (option) { return (React__default["default"].createElement("option", { value: option.value }, option.label)); }))),
                React__default["default"].createElement("div", { className: "modal-action" },
                    React__default["default"].createElement("button", { className: "btn btn-primary", type: "submit" }, "Accept"),
                    React__default["default"].createElement("div", { className: "btn", onClick: function () { return setIsOpen(false); } }, "Close"))))));
};

var DEFAULT_FILTER_FIELD = {
    field: "",
    operator: "eq",
    value: "",
    logic: "and",
...
var Filter = function (_a) {
    var condition = _a.condition, onHandleFilter = _a.onHandleFilter, columns = _a.columns;
    var _b = React.useState(condition.filter || []), listFilter = _b[0], setListFilter = _b[1];
    var _c = React.useState(false), isOpen = _c[0], setIsOpen = _c[1];
    var _d = React.useState(DEFAULT_FILTER_FIELD), currentFilter = _d[0], setCurrentFilter = _d[1];
    // handle remove filter
    var removeFilter = function (indexToRemove) {
        if (listFilter) {
            var newList = listFilter.filter(function (item) { return item.id !== indexToRemove; });
            setListFilter(newList);
            onHandleFilter(newList);
        }
    };
    // handle add new tag
    var addFilter = function (newFilter) {
        if (newFilter === void 0) { newFilter = DEFAULT_FILTER_FIELD; }
    ...
    // handle open modal
    var onHandleOpenModal = function (tag) {
    ...
    React.useEffect(function () {
        if (isOpen && !currentFilter.field) {
            setCurrentFilter(function (prev) { return (__assign$1(__assign$1({}, prev), { field: columns[0].accessor })); });
        }
    }, [columns, isOpen]);
    // handle submit form
    var onHandleSubmit = function (data) {
        console.log(66, data);
        if (data.id) {
            setIsOpen(false);
            var newList = __spreadArray([], listFilter.map(function (it) {
                if (it.id === data.id) {
                    return (it = __assign$1(__assign$1({}, data), { id: it.id }));
                }
                return it;
            }), true);
            setListFilter(newList);
            ...
            var newList = __spreadArray(__spreadArray([], listFilter, true), [__assign$1(__assign$1({}, data), { id: v4() })], false);
            setListFilter(newList);
            onHandleFilter(newList);
            setIsOpen(false);
        }
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null,
        React__default["default"].createElement("div", { className: "container mx-auto pt-4 px-4 sm:px-8 max-w-10xl" },
            React__default["default"].createElement("ul", { className: "flex flex-wrap mx-0 mb-0 mt-2 p-0" },
                React__default["default"].createElement("li", null,
                    React__default["default"].createElement(FaFilter, { className: "cursor-pointer mt-1 mr-4", onClick: function () { return addFilter(); } })),
                listFilter &&
                    listFilter.map(function (tag, index) { return (React__default["default"].createElement(React__default["default"].Fragment, null,
                        React__default["default"].createElement("li", { key: tag.id, className: "tag cursor-pointer" },
                            React__default["default"].createElement("span", { onClick: function () {
                                    onHandleOpenModal(tag);
                                } },
                                React__default["default"].createElement("span", null, tag === null || tag === void 0 ? void 0 : tag.field),
                                "\u00A0",
                                React__default["default"].createElement("span", { style: { color: "burlywood" } }, convertSignalToName(tag === null || tag === void 0 ? void 0 : tag.operator)),
                                "\u00A0",
                                React__default["default"].createElement("span", null, tag === null || tag === void 0 ? void 0 : tag.value)),
                            React__default["default"].createElement("span", { className: "tag-close-icon", onClick: function () { return removeFilter(tag.id); } }, "x")),
                        React__default["default"].createElement("li", { className: "uppercase mt-1 mr-1 ".concat(listFilter.length - 1 === index && "hidden") }, tag.logic))); }))),
        React__default["default"].createElement(ModalForm, { isOpen: isOpen, onHandleSubmit: onHandleSubmit, setIsOpen: setIsOpen, columns: columns, tag: currentFilter })));
};
...
var TableUI = function (_a) {
    var columns = _a.columns, data = _a.data, sortConfig = _a.sortConfig, onHandleSort = _a.onHandleSort, _b = _a.totalCount, totalCount = _b === void 0 ? 0 : _b, _c = _a.pageSize, pageSize = _c === void 0 ? 0 : _c, api = _a.api, _d = _a.allowFilter, allowFilter = _d === void 0 ? true : _d, _e = _a.allowPagination, allowPagination = _e === void 0 ? true : _e, onChangePage = _a.onChangePage, onHandleFilter = _a.onHandleFilter;
    var _f = React.useState([]), columnsResponse = _f[0], setColumnsResponse = _f[1];
    var _g = React.useState([]), dataResponse = _g[0], setDataResponse = _g[1];
    var _h = React.useState(0), pageCount = _h[0], setPageCount = _h[1];
    var _j = React.useState(null), sort = _j[0], setSort = _j[1];
    var _k = React.useState({
        page: 1,
        pageSize: 10,
    }), condition = _k[0], setCondition = _k[1];
    var prevCondition = usePrevious(condition);
    // Use the state and functions returned from useTable to build your UI
    var _l = reactTable.exports.useTable({
        columns: columnsResponse,
        data: dataResponse,
    }), getTableProps = _l.getTableProps, getTableBodyProps = _l.getTableBodyProps, headerGroups = _l.headerGroups, rows = _l.rows, prepareRow = _l.prepareRow;
    var requestSort = function (field) {
        ...
        if (onHandleSort) {
            onHandleSort({ field: field, dir: dir });
        }
        else {
            onHandleSortFunc({ field: field, dir: dir });
        }
    };
    var getIconArrow = function (sort, key) {
        if ((sort === null || sort === void 0 ? void 0 : sort.field) === key) {
            return (sort === null || sort === void 0 ? void 0 : sort.dir) === "asc" ? React__default["default"].createElement(FiArrowUp, null) : React__default["default"].createElement(FiArrowDown, null);
        }
    };
    var onHandleIconArrow = function (key) {
        if (sortConfig) {
    ...
    // handle sort table
    var onHandleSortFunc = function (param) {
        setSort(param);
    };
    var onChangePageFunc = function (selectedPage) {
        if (onChangePage) {
            onChangePage(selectedPage);
        }
        else {
            setCondition(function (prev) { return (__assign$1(__assign$1({}, prev), { page: selectedPage })); });
        }
    };
    var onHandleFilterFunc = function (param) {
        if (onHandleFilter) {
            onHandleFilter(param);
        }
        else {
            setCondition(function (prev) { return (__assign$1(__assign$1({}, prev), { filter: param.map(function (item) { return ({
                    field: item.field,
                    logic: item.logic,
    ...
    React.useEffect(function () {
        if (sort) {
            var sortArr_1 = [sort];
            setCondition(function (prev) { return (__assign$1(__assign$1({}, prev), { sorts: sortArr_1 })); });
        }
    }, [sort]);
    // prepare to call api
    React.useEffect(function () {
            ...
            if (api) {
                getData(api, condition)
                    ...
                    if (condition.pageSize && condition.pageSize !== 0) {
                        ...
                        if (!columns) {
                            var cols = mappingColumn(Object.keys(res.items[0]));
                ...
                if (!columns) {
                    var cols = mappingColumn(Object.keys(data[0]));
                    setColumnsResponse(cols);
                }
            }
        }
    ...
    return (React__default["default"].createElement("div", null,
        allowFilter && (React__default["default"].createElement(Filter, { condition: condition, onHandleFilter: onHandleFilterFunc, columns: columns ? columns : columnsResponse })),
        React__default["default"].createElement("div", { className: "container mx-auto pt-4 px-4 sm:px-8 max-w-10xl" },
            React__default["default"].createElement("div", { className: "overflow-x-auto" },
                React__default["default"].createElement("table", __assign$1({ className: "table w-full" }, getTableProps()),
                    React__default["default"].createElement("thead", null, headerGroups.map(function (headerGroup) { return (React__default["default"].createElement("tr", __assign$1({}, headerGroup.getHeaderGroupProps()),
                        React__default["default"].createElement("th", null),
                        headerGroup.headers.map(function (column) { return (React__default["default"].createElement("th", __assign$1({}, column.getHeaderProps(), { className: "cursor-pointer", onClick: function () { return requestSort(column.Header); } }),
                            React__default["default"].createElement("div", { className: "flex gap-2" },
                                column.render("Header"),
                                onHandleIconArrow(column.Header)))); }))); })),
                    React__default["default"].createElement("tbody", __assign$1({}, getTableBodyProps()), rows.map(function (row, key) {
                        prepareRow(row);
                        return (React__default["default"].createElement("tr", __assign$1({}, row.getRowProps()),
                            React__default["default"].createElement("th", null, key + 1),
                            row.cells.map(function (cell) {
                                return (React__default["default"].createElement("td", __assign$1({}, cell.getCellProps()), cell.render("Cell")));
                            })));
                    })))),
            allowPagination && (React__default["default"].createElement(PaginationUI, { currentPageIndex: condition.page - 1, pageCount: pageCount, onChangePage: function (param) { return onChangePageFunc(param + 1); } })))));
};

var DEFAULT_FILTER_CONTEXT = {
    condition: {
        page: 1,
        pageSize: 10,
    },
...
React.createContext(DEFAULT_FILTER_CONTEXT);
...
var useAppContext = function () { return React.useContext(AppContext); };

var NavigationUI = function () {
    var _a = useAppContext(), isExpanded = _a.isExpanded, setIsExpanded = _a.setIsExpanded;
    var onHandleExpandMenu = function () {
        setIsExpanded(!isExpanded);
    };
    return (React__default["default"].createElement("div", { className: "navbar mb-2 shadow-lg bg-neutral text-neutral-content" },
        React__default["default"].createElement("div", { className: "flex-none hidden lg:flex" },
            React__default["default"].createElement("button", { className: "btn btn-square btn-ghost", onClick: onHandleExpandMenu },
                React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", className: "inline-block w-6 h-6 stroke-current" },
                    React__default["default"].createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M4 6h16M4 12h16M4 18h16" })))),
        React__default["default"].createElement("div", { className: "flex-1 hidden px-2 mx-2 lg:flex" },
            React__default["default"].createElement("span", { className: "text-lg font-bold" }, "Savvycom Table Component")),
        React__default["default"].createElement("div", { className: "flex-1 lg:flex-none" },
            React__default["default"].createElement("div", { className: "form-control" },
                React__default["default"].createElement("input", { type: "text", placeholder: "Search", className: "input input-ghost" }))),
        React__default["default"].createElement("div", { className: "flex-none" },
            React__default["default"].createElement("button", { className: "btn btn-square btn-ghost" },
                React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", className: "inline-block w-6 h-6 stroke-current" },
        ...
        React__default["default"].createElement("div", { className: "flex-none" },
            React__default["default"].createElement("button", { className: "btn btn-square btn-ghost" },
                React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", className: "inline-block w-6 h-6 stroke-current" },
                    React__default["default"].createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" })))),
        React__default["default"].createElement("div", { className: "flex-none" },
            React__default["default"].createElement("div", { className: "avatar" },
                React__default["default"].createElement("div", { className: "rounded-full w-10 h-10 m-1" },
                    React__default["default"].createElement("img", { src: "https://i.pravatar.cc/500?img=32" }))))));
};

var Sidebar = function () {
    var isExpanded = useAppContext().isExpanded;
    return (React__default["default"].createElement("div", { style: isExpanded ? {} : { width: '4rem' }, className: "side-bar shadow-lg" },
        React__default["default"].createElement("div", { className: "flex flex-col items-center h-full overflow-hidden text-gray-400 bg-gray-900 rounded" },
            React__default["default"].createElement("a", { className: "flex items-center w-full px-3 mt-3", href: "#" },
                React__default["default"].createElement("svg", { className: "w-8 h-8 fill-current", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 20 20", fill: "currentColor" },
                    React__default["default"].createElement("path", { d: "M11 17a1 1 0 001.447.894l4-2A1 1 0 0017 15V9.236a1 1 0 00-1.447-.894l-4 2a1 1 0 00-.553.894V17zM15.211 6.276a1 1 0 000-1.788l-4.764-2.382a1 1 0 00-.894 0L4.789 4.488a1 1 0 000 1.788l4.764 2.382a1 1 0 00.894 0l4.764-2.382zM4.447 8.342A1 1 0 003 9.236V15a1 1 0 00.553.894l4 2A1 1 0 009 17v-5.764a1 1 0 00-.553-.894l-4-2z" })),
                isExpanded && (React__default["default"].createElement("span", { className: "ml-2 text-sm font-bold" }, "The App"))),
            React__default["default"].createElement("div", { className: "w-full px-2" },
                React__default["default"].createElement("div", { className: "flex flex-col items-center w-full mt-3 border-t border-gray-700" },
                    React__default["default"].createElement("a", { className: "flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-700 hover:text-gray-300", href: "#" },
                        React__default["default"].createElement("svg", { className: "w-6 h-6 stroke-current", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" },
                            React__default["default"].createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" })),
                        isExpanded && (React__default["default"].createElement("span", { className: "ml-2 text-sm font-medium" }, "Dasboard"))),
                    React__default["default"].createElement("a", { className: "flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-700 hover:text-gray-300", href: "#" },
                        React__default["default"].createElement("svg", { className: "w-6 h-6 stroke-current", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" },
                            React__default["default"].createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" })),
                        isExpanded && (React__default["default"].createElement("span", { className: "ml-2 text-sm font-medium" }, "Search"))),
                    React__default["default"].createElement("a", { className: "flex items-center w-full h-12 px-3 mt-2 text-gray-200 bg-gray-700 rounded", href: "#" },
                        React__default["default"].createElement("svg", { className: "w-6 h-6 stroke-current", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" },
                            React__default["default"].createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M16 8v8m-4-5v5m-4-2v2m-2 4h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" })),
                        isExpanded && (React__default["default"].createElement("span", { className: "ml-2 text-sm font-medium" }, "Insights"))),
                    React__default["default"].createElement("a", { className: "flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-700 hover:text-gray-300", href: "#" },
                        React__default["default"].createElement("svg", { className: "w-6 h-6 stroke-current", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" },
                            React__default["default"].createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M8 7v8a2 2 0 002 2h6M8 7V5a2 2 0 012-2h4.586a1 1 0 01.707.293l4.414 4.414a1 1 0 01.293.707V15a2 2 0 01-2 2h-2M8 7H6a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2v-2" })),
                        isExpanded && (React__default["default"].createElement("span", { className: "ml-2 text-sm font-medium" }, "Docs")))),
                React__default["default"].createElement("div", { className: "flex flex-col items-center w-full mt-2 border-t border-gray-700" },
                    React__default["default"].createElement("a", { className: "flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-700 hover:text-gray-300", href: "#" },
                        React__default["default"].createElement("svg", { className: "w-6 h-6 stroke-current", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" },
                            React__default["default"].createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" })),
                        isExpanded && (React__default["default"].createElement("span", { className: "ml-2 text-sm font-medium" }, "Products"))),
                    React__default["default"].createElement("a", { className: "flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-700 hover:text-gray-300", href: "#" },
                        React__default["default"].createElement("svg", { className: "w-6 h-6 stroke-current", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" },
                            React__default["default"].createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" })),
                        isExpanded && (React__default["default"].createElement("span", { className: "ml-2 text-sm font-medium" }, "Settings"))),
                    React__default["default"].createElement("a", { className: "relative flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-700 hover:text-gray-300", href: "#" },
                        React__default["default"].createElement("svg", { className: "w-6 h-6 stroke-current", xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" },
                            React__default["default"].createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z" })),
                        isExpanded && (React__default["default"].createElement("span", { className: "ml-2 text-sm font-medium" }, "Messages")),
                        React__default["default"].createElement("span", { className: "absolute top-0 left-0 w-2 h-2 mt-2 ml-2 bg-indigo-500 rounded-full" })))))));
};
